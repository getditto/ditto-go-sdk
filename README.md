...
```shell
curl -O https://software.ditto.live/go-linux-x86_64/Ditto/5.0.0-go-preview.1/dist/Ditto.tar.gz && tar xvfz Ditto.tar.gz
```

#### Linux aarch64

```
curl -O https://software.ditto.live/go-linux-aarch64/Ditto/5.0.0-go-preview.1/dist/Ditto.tar.gz && tar xvfz Ditto.tar.gz
```

#### macOS aarch64

```shell
curl -O https://software.ditto.live/go-macos-aarch64/Ditto/5.0.0-go-preview.1/dist/Ditto.tar.gz && tar xvfz Ditto.tar.gz
```
