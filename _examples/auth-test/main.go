...
func main() {
	...
	flag.StringVar(&persistenceDirectory, "persistence-directory", "/tmp/ditto-go-example-auth-test", "directory for Ditto persistence")
	flag.StringVar(&logExportPath, "log-export-path", "./ditto-go-example-auth-test-logexport.jsonl.gz", "path for exported log file")
	flag.Parse()
	...
	d.SetDeviceName("ditto-go-auth-test")
